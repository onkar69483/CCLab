...
static const flex_int16_t yy_base[15] =
    {   0,
        0,    0,   16,   17,    0,    0,    2,    0,    0,    8,
       17,   17,   17,   13
    } ;

static const flex_int16_t yy_def[15] =
    {   0,
       13,    1,   13,   13,   14,   14,   13,   14,    7,   13,
       13,   13,    0,   13
    } ;

static const flex_int16_t yy_nxt[24] =
    {   0,
        4,    5,    6,    4,    4,    7,    9,   10,   11,   11,
       11,   12,    9,   10,    8,   13,    3,   13,   13,   13,
       13,   13,   13
    } ;
...
char *yytext;
#line 1 "a_start_end_counter.l"
#line 2 "a_start_end_counter.l"
#include <stdio.h>
#include <ctype.h>
...
YY_RULE_SETUP
#line 10 "a_start_end_counter.l"
{ count++; }
	YY_BREAK
case 2:
/* rule 2 can match eol */
YY_RULE_SETUP
#line 11 "a_start_end_counter.l"
;     
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 12 "a_start_end_counter.l"
;      
	YY_BREAK
case 4:
YY_RULE_SETUP
#line 14 "a_start_end_counter.l"
ECHO;
	YY_BREAK
#line 753 "lex.yy.c"
